define([
  ...
  return declare([_WidgetBase, _TemplatedMixin], {
    ...
    startup: function() {
      ...
      html.place(this.search.domNode, this.searchTree);
      this.search.startup();
      ...
      sources.push({
        ...
        exactMatch: false,  
        searchFields: [this.params.codFieldSeq],  
        displayField: this.params.codFieldSeq,  
      ...
      sources.push({
        featureLayer: new FeatureLayer(this.params.serviceUrl),        
        exactMatch: false,
        searchFields: [this.params.codFieldDen],  
        displayField: this.params.codFieldDen,  
        outFields: [this.params.outFields],  
        maxResults: 6,  
        maxSuggestions: 6,  
        enableSuggestions: true,  
      ...
      sources.push({
        featureLayer: new FeatureLayer(this.params.serviceUrl),        
        exactMatch: false,  
        searchFields: [this.params.codFieldProp],  
        displayField: this.params.codFieldProp,  
        outFields: [this.params.outFields],  
        maxResults: 6,  
        maxSuggestions: 6,  
        enableSuggestions: true,  
